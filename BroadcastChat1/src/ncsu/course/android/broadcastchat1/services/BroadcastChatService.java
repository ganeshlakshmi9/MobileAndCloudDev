 ...
 */
public class BroadcastChatService extends Service{
    // Debugging
    ...
    public static final int SERVICE_BACKGROUND 	= 2;
        ...
        public void run() {
    		try {
    			...
    			while (true) { 
	    			...
	    			mHandler.obtainMessage(Constants.MESSAGE_READ,-1,-1, s)
	    			.sendToTarget();              
	    		} 
			} catch (IOException e) {
    			e.printStackTrace();
